...
const VerticalCutReveal = forwardRef<VerticalCutRevealRef, TextProps>(
  (
    ...
    // Initialize animation state based on autoStart prop
    ...
    // Call onStart callback when auto-starting animation
    useEffect(() => {
      if (autoStart && isAnimating && !hasCalledOnStart.current) {
        hasCalledOnStart.current = true;
        onStart?.();
      }
    }, [autoStart, isAnimating, onStart]);
    ...
    useImperativeHandle(ref, () => ({
      ...
      reset: () => {
        ...
        hasCalledOnStart.current = false;
      },
    }));
